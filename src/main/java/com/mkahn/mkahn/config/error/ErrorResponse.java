...
public class ErrorResponse {
    ...
    private ErrorResponse(final ErrorCode code, final String... args) {
        this.message = args[0];
        this.status = code.getStatus();
        this.code = code.getCode();
        this.errors = new ArrayList<>();
    ...
    public static ErrorResponse of(final ErrorCode code, final String... args) {
        return new ErrorResponse(code, args);
    }
